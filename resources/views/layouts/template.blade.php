...
<html lang="en">
  ...
  <body>
    <div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
			<h1 id="colorlib-logo"><a href="/"><span class="img" style="background-image: url(img/slider-bg-1.png);"></span>Multazam Wisata Rohani</a></h1>
  ...
  <footer class="ftco-footer ftco-bg-dark ftco-section">
              ...
              <div class="col-md">
                <div class="ftco-footer-widget mb-4 ml-md-4">
                  ...
                  <ul class="list-unstyled photo">
                    ...
                    <li><a href="#" class="img" style="background-image: url(/img/gallery/13.jpeg);"></a></li>
                  </ul>
                </div>
              </div>
              <div class="col-md">
      ...
      Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Kelompok 7 <i class="icon-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Rapli Bagus P</a>
